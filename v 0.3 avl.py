...
def clearId(event):  # funcao para limpar text field quando clicado
    EntryID.delete('0', END)

def clearName(event):   # funcao  para limpar text field quando clicado
...
def remover_button():
    ...
    entrada.insert(0, '')  # seta o texto
    entrada.pack()  # gerenciador de geometria
    entrada.focus_set()  # obtem o foco para a entrada de texto
    remover_btn = Button(janelaRemover, text='Remover', width=20, command=remover_button_func)  # botão de inserir
    remover_btn.pack()
